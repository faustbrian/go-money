...
- Adopt the checksum-verified `go-library-tools` v1.4.0 CLI and immutable
  ...
  `make cohesion` and required CI gates, and resolve released Golib dependencies
  through their public module identities before any bootstrap fallback, without
  changing the money API or runtime behavior.
